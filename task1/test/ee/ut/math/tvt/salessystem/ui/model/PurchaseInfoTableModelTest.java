...
public class PurchaseInfoTableModelTest {
    ...
    public void testAddSoldItem() {
   	 purchaseInfoTableModel.addItem(item1);
            ...
            assertEquals(item1.getStockItem().getName(), item4.getStockItem().getName());
            assertEquals(item1.getStockItem().getDescription(), item4.getStockItem().getDescription());
            assertEquals(item1.getStockItem().getPrice(), item4.getStockItem().getPrice(), 0.0001);
            assertEquals(item1.getStockItem().getQuantity(), item4.getStockItem().getQuantity());
